...
def spiral(outer_diam: float, inner_diam: float, wire_diam: float, segment_count: int):
    ...
    N=20 #Numero de vueltas
    h=110 #Altura de la bobina en mm
...
def spiral2(outer_diam2: float, inner_diam: float, wire_diam: float, segment_count: int):
    ...
    h2=110 #Altura de la bobina en mm
...
outer_diam = 9 #Esto ya nos da igual, solo se va a tener un diametro
inner_diam = 0.02
outer_diam2 = 13
outer_diam3= 17
element_distance = 0
winding_casing_distance = 1
...
tms_coil.write("Prueba2SinNucleo.tcd")
