...
def spiral(outer_diam: float, inner_diam: float, wire_diam: float, segment_count: int):
    ...
    N=4.5 #Numero de vueltas
    h=1.8 #Altura de la bobina en mm
...
def spiral2(outer_diam2: float, inner_diam: float, wire_diam: float, segment_count: int):
    ...
    N2=20 #Numero de vueltas
    h2=8 #Altura de la bobina en mm
...
def spiral9(outer_diam3: float, inner_diam: float, wire_diam2: float, segment_count: int):
    ...
    h=0.8 #Altura de la bobina en mm
...
def spiral10(outer_diam4: float, inner_diam: float, wire_diam2: float, segment_count: int):
    ...
    N2=0.6935 #Numero de vueltas
    h2=0.5 #Altura de la bobina en mm
...
def figure_of_8_wire_path(
    ...
    spiral_1 = (
        path + np.array((0, 5.259, -winding_casing_distance))[:, None]
    )
    ...
    spiral_3 = np.fliplr(
         #* np.array((-1, 1, 1))[:, None]
        path + np.array((5.641, 0, -winding_casing_distance))[:, None]
    )
    ...
    spiral_9 = (
        path + np.array((-0.971, -1.0035, -winding_casing_distance))[:, None]
    )
...
outer_diam = 2.9 #Esto ya nos da igual, solo se va a tener un diametro
inner_diam = 0.02
outer_diam2 = 10
outer_diam3= 0.4
outer_diam4= 2
...
tms_coil.write("EstimuladorS05.tcd")