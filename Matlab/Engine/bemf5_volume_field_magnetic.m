function H = bemf5_volume_field_magnetic(Points, c, P, t, Center, Area, normals, R, prec)
%   Computes magnetic field for an array Points anywhere in space (line,
